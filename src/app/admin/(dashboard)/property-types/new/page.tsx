...
export const metadata = {
  title: 'Add Property Type | Admin Dashboard',
};
  ...
  return (
    <div>
      <div style={{ marginBottom: '2rem' }}>
        ...
        <h1 style={{ fontSize: '1.875rem', fontWeight: 700, color: '#0f172a', margin: '0 0 0.5rem 0' }}>Add New Property Type</h1>
        <p style={{ color: '#64748b', margin: 0 }}>Create a new root category or subcategory.</p>
      </div>

      <div style={{ maxWidth: '600px' }}>
        <PropertyTypeForm rootTypes={rootTypes} />
      </div>
    </div>
  );
}
